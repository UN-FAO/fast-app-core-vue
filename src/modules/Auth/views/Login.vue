  ...
  <div class="row justify-center">
    <q-card class="col-md-6 col-sm-8 col-lg-5 text-white"
      ...
      <q-card-title class="card-title bg-primary text-center">
        ...
        <h4 style="color:white; text-transform: uppercase;font-size: -webkit-xxx-large;">FAST POC</h4>
      </q-card-title>
      <q-card-main>
        <q-field icon="person">
        ...
        <div class="col-md-12 col-lg-12 justify-center">
          <router-link :to="{ path: 'register' }">Dont have an account?</router-link>
        </div>
      </q-card-main>
